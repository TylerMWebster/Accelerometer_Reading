void calibrate(double samples){
  ...
  xslope = (grx - initx) / samples;
  yslope = (gry - inity) / samples;
  zslope = (grz - initz) / samples;  
  slopes[0] = xslope;
  slopes[1] = yslope;
  slopes[2] = zslope;
  Serial.println("Calibration Complete");
  Serial.print(xslope); Serial.print(", "); 
  Serial.print(yslope); Serial.print(", ");
  Serial.println(zslope);
}
